defmodule Rumbl.MultimediaTest do
  ...
  describe "videos" do
    ...
    @invalid_attrs %{" url": nil, description: nil, title: nil, users: nil}
    ...
    test "create_video/1 with valid data creates a video" do
      valid_attrs = %{" url": "some  url", description: "some description", title: "some title", users: "some users"}

      assert {:ok, %Video{} = video} = Multimedia.create_video(valid_attrs)
      assert video. url == "some  url"
      assert video.description == "some description"
      assert video.title == "some title"
      assert video.users == "some users"
    end
    ...
    test "update_video/2 with valid data updates the video" do
      video = video_fixture()
      update_attrs = %{" url": "some updated  url", description: "some updated description", title: "some updated title", users: "some updated users"}

      assert {:ok, %Video{} = video} = Multimedia.update_video(video, update_attrs)
      assert video. url == "some updated  url"
      assert video.description == "some updated description"
      assert video.title == "some updated title"
      assert video.users == "some updated users"
    end
  ...
  describe "videos" do
    ...
    @invalid_attrs %{description: nil, title: nil, url: nil, users: nil}
    ...
    test "create_video/1 with valid data creates a video" do
      valid_attrs = %{description: "some description", title: "some title", url: "some url", users: "some users"}
    ...
    test "update_video/2 with valid data updates the video" do
      video = video_fixture()
      update_attrs = %{description: "some updated description", title: "some updated title", url: "some updated url", users: "some updated users"}
